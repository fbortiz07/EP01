window.onload = function()
{
    ...
    */
    var validaSudoku = function(valor, id, sudoku)
    {
        ...
        //solucion = sudoku.respuesta;
        // (valor === solucion[[parteID[0]][parteID[1]][parteID[2]][parteID[3]]] ?
                                              //nom_div("td_"+id).className = "correcto":
                                              //nom_div("td_"+id).className = "error"); Ternario que no funcionó.

        if(valor === sudoku.respuesta[parteID[0]][parteID[1]][parteID[2]][parteID[3]])
        {
            nom_div("td_"+id).className = "correcto"; //si el numero ingresado es correcto da color verde
        }
        else
        {
            nom_div("td_"+id).className = "error"; //si el numero ingrsado es incorrecto da color rojo
        }
        //console.log(parteID);
        //console.log(valor);
    }
