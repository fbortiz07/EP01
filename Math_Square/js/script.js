    ...
    var validaRespuesta = function(id)
    {
        ...
        for (var i=0; i < mathSquare.length -1 ; i++)
        {
          if(i % 2 === 0)
          {
            ...
            var valhorizontal = eval(respuesta.horizontal.ecuacion);
            var valvertical = eval(respuesta.vertical.ecuacion);
            if(valhorizontal === respustaMatriz.horizontal)
            {
            ...
            if(valvertical === respustaMatriz.vertical)
            {
